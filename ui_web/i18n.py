...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "profile.gap_map.subtitle": "Your real gaps across all your scored jobs, grouped by theme and ranked by how many roles each blocks. Click a gap for how to defend it.",
