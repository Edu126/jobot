...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "action.applied_title": "You marked this as applied — the badge stays even if the job re-surfaces in a later search.",
    ...
    "es": {
        ...
        "action.applied_title": "Marcaste esta vacante como postulada — el badge se mantiene aunque la vacante vuelva a aparecer en una búsqueda posterior.",
