...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        # Prep — the land-it kit (REQ-023)
        "prep.page_title": "Prep",
        "prep.list.heading": "Interview prep",
        "prep.list.empty": "No interviews yet. Got a callback? Start prepping for one below.",
        "prep.entry.heading": "Prep for an interview",
        "prep.entry.company": "Company",
        "prep.entry.role": "Role",
        "prep.entry.vacancy": "Paste the job link or description (optional)",
        "prep.entry.submit": "Start prep",
        "prep.entry.hint": "Paste a link or the JD and we read the posting for you. We'll reuse a job you've already worked on when we can.",
        "prep.entry.smart_ph": "Paste the job link — or the full job description. We'll do the magic.",
        "prep.entry.lines_pasted": "lines pasted",
        "prep.entry.clear": "Clear",
        "prep.entry.optional_toggle": "Add company / role (optional)",
        "prep.entry.importing": "Reading the posting…",
        "prep.import.read_ok": "We read the posting",
        "prep.import.chars": "chars",
        "prep.import.start": "Looks right — start prep",
        "prep.import.confirm_hint": "Fix the company or role if we got it wrong.",
        "prep.import.failed": "We couldn't read that. Paste the job description instead.",
        "prep.confirm.heading": "Is this the job you're interviewing for?",
        "prep.confirm.none": "None of these — use what I typed",
        "prep.card.match": "Match",
        "prep.card.open": "Open prep",
        "prep.fit.band.strong": "Strong fit",
        "prep.fit.band.solid": "Solid fit",
        "prep.fit.band.stretch": "Stretch role",
        "prep.fit.angle": "Your angle:",
        "prep.fit.stretch_note": "They invited you — lean on your strengths and prepare the gaps below.",
        "prep.fit.lean_in": "Lean into",
        "prep.fit.shore_up": "Be ready to speak to",
        "prep.detail.back": "All interviews",
        "prep.detail.status.scheduled": "Interview scheduled",
        "prep.detail.delete": "Delete",
        "prep.detail.delete_confirm": "Delete this prep session?",
        "prep.loading": "Working…",
        "prep.intel.heading": "Company & news intel",
        "prep.intel.culture": "Culture & tone",
        "prep.intel.strategy": "Strategic focus",
        "prep.intel.news": "Recent news",
        "prep.intel.refresh": "Refresh news",
        "prep.intel.fetch": "Try fetching intel",
        "prep.intel.empty": "No solid company info found yet.",
        "prep.intel.sources": "Sources",
        "prep.kit.qa_heading": "STAR Q&A bank",
        "prep.kit.reverse_heading": "Questions to ask them",
        "prep.kit.empty": "We couldn't build the kit just now.",
        "prep.kit.retry": "Try again",
        "prep.kit.grounded_on": "Grounded on:",
        "prep.kit.layer.resume": "Your résumé",
        "prep.kit.layer.jd": "This job description",
        "prep.kit.layer.role": "This role",
        "prep.kit.layer.gaps": "known gaps",
        "prep.kit.copy": "Copy",
        "prep.entry.link": "Paste the job link (optional)",
        "prep.tab.qa": "STAR Q&A",
        "prep.tab.likely": "Likely questions",
        "prep.qa.all": "All",
        "prep.tab.reverse": "Questions to ask",
        "prep.carousel.prev": "Prev",
        "prep.carousel.next": "Next",
        "prep.feedback.helpful": "Helpful?",
        "prep.feedback.thanks": "Thanks!",
        "prep.intel.not_found_pre": "We don't have company intel for",
        "prep.intel.general": "The prep below is general — based on your profile and the role.",
        "prep.kind.behavioral": "Behavioral",
        "prep.kind.situational": "Situational",
        "prep.kind.why_you": "Why you",
        "prep.kind.culture_fit": "Culture fit",
        "prep.kind.defensive_gap": "Defensive (gap)",
        "action.prep": "Prep interview",
        # Common actions
        "action.save": "Save",
        ...
        "profile.gap_map.subtitle": "Your real gaps across your recent strong-fit roles, grouped by theme and ranked by how many roles each blocks. Click a gap for how to defend it.",
        "profile.gap_map.flush": "Rebuild",
        "profile.gap_map.flush_hint": "Recompute the gap map from scratch",
        "profile.gap_map.rebuild_unavailable": "Can't rebuild right now — the AI is unavailable (no key or quota reached). Your map was left unchanged.",
        "profile.gap_map.in_n_roles": "in {n} roles",
        "profile.gap_map.in_1_role": "in 1 role",
        "profile.gap_map.pillar.technical": "Technical & Tools",
        "profile.gap_map.pillar.certifications": "Certifications & Languages",
        "profile.gap_map.pillar.domain": "Domain & Experience",
        "profile.gap_map.pillar_empty": "No gaps here",
        "profile.gap_map.grouped_terms": "Grouped from",
        "profile.gap_map.dismiss": "Not a real gap — remove",
    ...
    "es": {
        ...
        # Preparación — el kit para conseguir el puesto (REQ-023)
        "prep.page_title": "Preparación",
        "prep.list.heading": "Preparación de entrevistas",
        "prep.list.empty": "Aún no hay entrevistas. ¿Te llamaron? Empieza a preparar una abajo.",
        "prep.entry.heading": "Prepárate para una entrevista",
        "prep.entry.company": "Empresa",
        "prep.entry.role": "Rol",
        "prep.entry.vacancy": "Pega el link o la descripción de la vacante (opcional)",
        "prep.entry.submit": "Empezar preparación",
        "prep.entry.hint": "Pega un link o la descripción y leemos la vacante por ti. Cuando podamos, reusamos un empleo que ya trabajaste.",
        "prep.entry.smart_ph": "Pega el link de la vacante — o la descripción completa. Nosotros hacemos la magia.",
        "prep.entry.lines_pasted": "líneas pegadas",
        "prep.entry.clear": "Limpiar",
        "prep.entry.optional_toggle": "Agregar empresa / rol (opcional)",
        "prep.entry.importing": "Leyendo la vacante…",
        "prep.import.read_ok": "Leímos la vacante",
        "prep.import.chars": "caracteres",
        "prep.import.start": "Se ve bien — empezar preparación",
        "prep.import.confirm_hint": "Corrige la empresa o el rol si nos equivocamos.",
        "prep.import.failed": "No pudimos leerla. Pega la descripción de la vacante.",
        "prep.confirm.heading": "¿Es este el empleo de tu entrevista?",
        "prep.confirm.none": "Ninguno — usa lo que escribí",
        "prep.card.match": "Afinidad",
        "prep.card.open": "Abrir preparación",
        "prep.fit.band.strong": "Muy buen encaje",
        "prep.fit.band.solid": "Buen encaje",
        "prep.fit.band.stretch": "Rol exigente",
        "prep.fit.angle": "Tu ángulo:",
        "prep.fit.stretch_note": "Te invitaron — apóyate en tus fortalezas y prepara las brechas de abajo.",
        "prep.fit.lean_in": "Apóyate en",
        "prep.fit.shore_up": "Prepárate para hablar de",
        "prep.detail.back": "Todas las entrevistas",
        "prep.detail.status.scheduled": "Entrevista agendada",
        "prep.detail.delete": "Eliminar",
        "prep.detail.delete_confirm": "¿Eliminar esta preparación?",
        "prep.loading": "Trabajando…",
        "prep.intel.heading": "Empresa y noticias",
        "prep.intel.culture": "Cultura y tono",
        "prep.intel.strategy": "Enfoque estratégico",
        "prep.intel.news": "Noticias recientes",
        "prep.intel.refresh": "Actualizar noticias",
        "prep.intel.fetch": "Intentar buscar intel",
        "prep.intel.empty": "Aún no se encontró información sólida de la empresa.",
        "prep.intel.sources": "Fuentes",
        "prep.kit.qa_heading": "Banco de preguntas STAR",
        "prep.kit.reverse_heading": "Preguntas para hacerles",
        "prep.kit.empty": "No pudimos armar el kit en este momento.",
        "prep.kit.retry": "Reintentar",
        "prep.kit.grounded_on": "Basado en:",
        "prep.kit.layer.resume": "Tu currículum",
        "prep.kit.layer.jd": "Esta descripción",
        "prep.kit.layer.role": "Este rol",
        "prep.kit.layer.gaps": "brechas reales",
        "prep.kit.copy": "Copiar",
        "prep.entry.link": "Pega el link de la vacante (opcional)",
        "prep.tab.qa": "Preguntas STAR",
        "prep.tab.likely": "Preguntas probables",
        "prep.qa.all": "Todas",
        "prep.tab.reverse": "Preguntas para hacer",
        "prep.carousel.prev": "Anterior",
        "prep.carousel.next": "Siguiente",
        "prep.feedback.helpful": "¿Te sirvió?",
        "prep.feedback.thanks": "¡Gracias!",
        "prep.intel.not_found_pre": "No tenemos intel de la empresa para",
        "prep.intel.general": "La preparación de abajo es general — basada en tu perfil y el rol.",
        "prep.kind.behavioral": "Conductual",
        "prep.kind.situational": "Situacional",
        "prep.kind.why_you": "Por qué tú",
        "prep.kind.culture_fit": "Encaje cultural",
        "prep.kind.defensive_gap": "Defensiva (brecha)",
        "action.prep": "Preparar entrevista",
        # Acciones comunes
        "action.save": "Guardar",
        ...
        "profile.gap_map.subtitle": "Tus brechas reales en tus roles recientes de mejor ajuste, agrupadas por tema y ordenadas por cuántos roles bloquea cada una. Haz clic en una brecha para ver cómo defenderla.",
        "profile.gap_map.flush": "Reconstruir",
        "profile.gap_map.flush_hint": "Recalcular el mapa de brechas desde cero",
        "profile.gap_map.rebuild_unavailable": "No se puede reconstruir ahora — la IA no está disponible (sin clave o cuota alcanzada). Tu mapa quedó intacto.",
        "profile.gap_map.in_n_roles": "en {n} roles",
        "profile.gap_map.in_1_role": "en 1 rol",
        "profile.gap_map.pillar.technical": "Técnicas y Herramientas",
        "profile.gap_map.pillar.certifications": "Certificaciones e Idiomas",
        "profile.gap_map.pillar.domain": "Dominio y Experiencia",
        "profile.gap_map.pillar_empty": "Sin brechas aquí",
        "profile.gap_map.grouped_terms": "Agrupa",
        "profile.gap_map.dismiss": "No es una brecha real — quitar",
